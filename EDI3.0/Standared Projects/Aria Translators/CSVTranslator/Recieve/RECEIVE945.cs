...
namespace CSVTranslator
{
    public class RECEIVE945 : RecieveBase
    {
        ...
        //FODA-Overloading DO Method [BEGIN]
        /// <summary>
        ...
        protected override void Import(string tempdb)
        {
            ...
            string ShippingOrderHeader_T_columns = "OID,SenderID,PartnerID,ShippingOrder,PurchaseOrderNumber,Weight,TransportationMethod,StandardCarrierAlphaCode,Routing,TransactionPurposeCode,TransactionPurpose,CPUA,CSEAL_NO,CFCHRGTRM,TRAILER_NO,CPRO_NO,CARRAUTHNO,BOLNO_STD";
            ...
            if (VariableChechker<string>("MPUA", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MPUA"][start].ToString() + "'";
            }
            if (VariableChechker<string>("MSEAL_NO", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MSEAL_NO"][start].ToString() + "'";
            }
            if (VariableChechker<string>("MFCHRGTRM", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MFCHRGTRM"][start].ToString() + "'";
            }
            //TRAILER_NO,CPRO_NO,CARRAUTHNO,BOLNO_STD
            if (VariableChechker<string>("MTRAILER_NO", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MTRAILER_NO"][start].ToString() + "'";
            }
            if (VariableChechker<string>("MCPRO_NO", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MCPRO_NO"][start].ToString() + "'";
            }
            if (VariableChechker<string>("MCARRAUTHNO", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MCARRAUTHNO"][start].ToString() + "'";
            }
            if (VariableChechker<string>("MBOLNO_STD", start))
            {
                ShippingOrderHeader_T_values = ShippingOrderHeader_T_values + "," + "'" + _variablesDictionary["MBOLNO_STD"][start].ToString() + "'";
            }
            // foda
