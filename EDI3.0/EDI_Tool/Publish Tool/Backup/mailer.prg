LPARAMETERS lcMailUserName, lcMailPassword, lcFrom, lcTo, lcSubject, lcTextBody, lcAttachment, lcErrors
...
WITH loMail
	...
	.cUserName = lcMailUserName
	.cPassword = lcMailPassword
	...
	* .cAttachment = "C:\Users\mohamed.m.EG01\Desktop\New Text Document.txt"
	IF TYPE("lcAttachment") = "C" AND !EMPTY(ALLTRIM(lcAttachment))
